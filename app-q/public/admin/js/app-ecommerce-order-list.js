...
$(function() {
    ...
    n.length && (e = n.DataTable({
        ...
        columnDefs: [{
            ...
            targets: 2,
            render: function(e, t, a, s) {
                return '<a href="order/show/' + a.id + '"><span class="fw-medium">#' + a.order + "</span></a>"
            }
        }, {
            targets: 3,
            render: function(e, t, a, s) {
            ...
            orderable: !1,
            render: function(e, t, a, s) {
                return '<div class="d-flex justify-content-sm-center align-items-sm-center"><button class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded"></i></button><div class="dropdown-menu dropdown-menu-end m-0"><a href="order/show/' + a.id + '" class="dropdown-item">View</a><a href="javascript:0;" class="dropdown-item delete-record">Delete</a></div></div>'
            }
        }],
        order: [3, "asc"],
