...
<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/auth-register-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 15:41:35 GMT -->
<head>
    <meta charset="utf-8" />
        ...
        <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
          ...
          <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-3">
                ...
                <input id="username" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Enter your username" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
          ...
          <p class="text-center">
            ...
            <a  href="{{ route('login') }}"> Sign in instead</span>
            </a>
          </p>
