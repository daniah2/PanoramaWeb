...
<div class="card-header">
 ...
 <button class="btn btn-secondary add-new btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasEcommerceCustomerAdd"><span><i class="bx bx-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">اضافة خدمة</span></span></button>
        </div>
      </div>
<br>
