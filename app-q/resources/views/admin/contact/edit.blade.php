      ...
      <form class="ecommerce-customer-add pt-0" style="width: 100%" enctype="multipart/form-data" id="eCommerceCustomerAddForm" method="POST"  action="{{route('service.update',$show->id)}}">
        ...
        <div class="ecommerce-customer-add-basic mb-12">
          ...
          <div class="mb-12">
            ...
            <input type="text" class="form-control" id="ecommerce-customer-add-name" required placeholder="العنوان" value="{{$show->title}}" name="title" aria-label="John Doe" />
 <br>
          
          </div>
          <div class="mb-12">
            <label class="form-label" for="ecommerce-customer-add-email">الوصف*</label>
            <textarea name="description" id="" cols="30" rows="10" class="form-control" required  placeholder="الوصف">{{$show->description}}</textarea>
 <br>
